...
{
    public class FoxMatrix4 : FoxStruct, IFoxValueType
    {
        ...
        public object Unwrap()
        {
            ...
            var row1 = new Vector4(Row1Value1, Row1Value2, Row1Value3, Row1Value4);
            var row2 = new Vector4(Row2Value1, Row2Value2, Row2Value3, Row2Value4);
            var row3 = new Vector4(Row3Value1, Row3Value2, Row3Value3, Row3Value4);
            var row4 = new Vector4(Row4Value1, Row4Value2, Row4Value3, Row4Value4);

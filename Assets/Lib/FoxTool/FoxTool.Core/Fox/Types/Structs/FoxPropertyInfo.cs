...
{
    public class FoxPropertyInfo : FoxStruct, IFoxValueType
    {
        ...
        {
            throw new NotImplementedException("PropertyInfo not yet implemented. Please report what file caused this error.");
        }
    }
}

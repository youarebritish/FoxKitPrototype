...
{
    public class FoxWideVector3 : FoxStruct, IFoxValueType
    {
        ...
        {
            throw new NotImplementedException("WideVector3 not yet implemented. Please report what file caused this error.");
        }
    }
}

...
namespace FoxKit.Framework.Tpp.Classes
{
    public class DestructionModelDescription : Data
    {
        ...
        [EntityProperty("fdesFile", FoxDataType.FilePtr, FoxContainerType.StaticArray)]
        public String FdesFile;

        [EntityProperty("desDataSetFile", FoxDataType.FilePtr, FoxContainerType.StaticArray)]
        public String DesDataSetFile;
    }
}

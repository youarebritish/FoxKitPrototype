...
{
    public class TppLensFlareShapeArray : TransformData
    {
        ...
        [EntityProperty("spriteCount", FoxDataType.UInt32, FoxContainerType.StaticArray)]
        public UInt32 SpriteCount;

        [EntityProperty("offsetScaleMin", FoxDataType.Float, FoxContainerType.StaticArray)]
        public Single OffsetScaleMin;

        [EntityProperty("offsetScaleMax", FoxDataType.Float, FoxContainerType.StaticArray)]
        public Single OffsetScaleMax;

        [EntityProperty("sizeScaleMin", FoxDataType.Float, FoxContainerType.StaticArray)]
        public Single SizeScaleMin;

        [EntityProperty("sizeScaleMax", FoxDataType.Float, FoxContainerType.StaticArray)]
        public Single SizeScaleMax;

        [EntityProperty("randomColorMin", FoxDataType.Color, FoxContainerType.StaticArray)]
        public Color RandomColorMin;

        [EntityProperty("randomColorMax", FoxDataType.Color, FoxContainerType.StaticArray)]
        public Color RandomColorMax;

        [EntityProperty("randomSeed", FoxDataType.UInt32, FoxContainerType.StaticArray)]
